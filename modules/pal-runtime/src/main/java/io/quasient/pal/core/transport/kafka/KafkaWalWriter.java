...
import io.quasient.pal.messages.LogMessageHeader;
...
public class KafkaWalWriter extends WalWriter {
  ...
  private void setProducerProperties(
    ...
    String KEY_SERIALIZER = "io.quasient.pal.serdes.kafka.KafkaKeySerializer";
    String VALUE_SERIALIZER = "io.quasient.pal.serdes.kafka.KafkaMessageSerializer";
