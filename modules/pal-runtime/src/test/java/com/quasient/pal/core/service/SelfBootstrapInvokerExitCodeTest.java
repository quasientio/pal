...
import static com.quasient.pal.core.service.SelfBootstrapInvoker.EXIT_INVALID_RETURN_VALUE;
import static com.quasient.pal.core.service.SelfBootstrapInvoker.EXIT_MAIN_THREW_EXCEPTION;
import static com.quasient.pal.core.service.SelfBootstrapInvoker.EXIT_SUCCESS;
import static com.quasient.pal.core.service.SelfBootstrapInvoker.EXIT_UNEXPECTED_RESPONSE_TYPE;
        ...
        .thenAnswer(
            inv -> {
              ...
              response.instanceMethodCall =
                  new com.quasient.pal.messages.colfer.InstanceMethodCall();
              return response;
            });
