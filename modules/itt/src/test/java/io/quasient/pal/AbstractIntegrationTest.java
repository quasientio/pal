...
public abstract class AbstractIntegrationTest {
   ...
   *   <li>Add a DEBUG-level logger for io.quasient.pal.core package
   * </ul>
   *
  ...
  private String createPeerSpecificLoggingConfig(String peerName, String palHome)
    ...
    for (String line : lines) {
      ...
      } else if (line.contains("<logger name=\"io.quasient.pal\" level=\"info\"")) {
        // Add DEBUG logger for io.quasient.pal.core before the general logger
        modifiedLines.add(
            "    <logger name=\"io.quasient.pal.core\" level=\"DEBUG\" additivity=\"false\">");
