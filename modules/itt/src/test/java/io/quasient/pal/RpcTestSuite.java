...
import io.quasient.pal.rpc.binary.CallMessageIT;
import io.quasient.pal.rpc.binary.ComplexArgsMessageIT;
import io.quasient.pal.rpc.binary.ConstructorMessageIT;
...
import io.quasient.pal.rpc.json.PutGetArrayMessageIT;
import io.quasient.pal.rpc.json.dsl.RpcChainIT;
...
@Suite.SuiteClasses({
  ...
  // JSON RPC tests
  io.quasient.pal.rpc.json.CallMessageIT.class,
  CallArrayMessageIT.class,
  io.quasient.pal.rpc.json.ComplexArgsMessageIT.class,
  io.quasient.pal.rpc.json.ConstructorMessageIT.class,
  io.quasient.pal.rpc.json.ControlMessageIT.class,
  io.quasient.pal.rpc.json.GetArrayMessageIT.class,
  io.quasient.pal.rpc.json.GetMessageIT.class,
  JsonRpcResponseErrorIT.class,
  io.quasient.pal.rpc.json.MetaMessageIT.class,
  io.quasient.pal.rpc.json.PutMessageIT.class,
