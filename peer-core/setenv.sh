...
PICOCLI_PATH=$MVN_REPO/info/picocli/picocli/4.0.0-beta-2/picocli-4.0.0-beta-2.jar
...
PEER_CORE_PATH=$MVN_REPO/com/ittera/cometa/peer-core/1.0-SNAPSHOT/peer-core-1.0-SNAPSHOT.jar
...
PEER_RUNNER_PATH=$MVN_REPO/com/ittera/cometa/peer-runner/1.0-SNAPSHOT/peer-runner-1.0-SNAPSHOT.jar

TARGET_APP_PATH=$MVN_REPO/org/springframework/samples/spring-petclinic/2.1.0.BUILD-SNAPSHOT/spring-petclinic-2.1.0.BUILD-SNAPSHOT.jar

CLASSPATH=$PEER_ITT_APPS_PATH:$COMPILED_CLASSES:$ASPECTJ_PATH:$GUAVA_PATH:$ORGJSON_PATH:$GUICE_PATH:$JAVAX_INJECT_PATH:$PROTOBUF_PATH:$KAFKA_PATH:$JEROMQ_PATH:$SLF4J_PATH:$LOGBACK_PATH:$COMMONS_PATH:$ZOOKEEPER_PATH:$PICOCLI_PATH:$PEER_COMMON_PATH:$PEER_SERDES_PATH:$PEER_CXN_PATH:$PEER_AJ_PATH:$PEER_CORE_PATH:$TARGET_APP_PATH:$PEER_RUNNER_PATH
