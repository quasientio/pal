...
PEER_CLI_PATH=$MVN_REPO/com/ittera/cometa/peer-client/1.0-SNAPSHOT/peer-client-1.0-SNAPSHOT.jar
PEER_SERDES_PATH=$MVN_REPO/com/ittera/cometa/peer-serdes/1.0-SNAPSHOT/peer-serdes-1.0-SNAPSHOT.jar

CLASSPATH=$COMPILED_CLASSES:$ASPECTJ_PATH:$GUAVA_PATH:$GUICE_PATH:$JAVAX_INJECT_PATH:$PROTOBUF_PATH:$KAFKA_PATH:$JEROMQ_PATH:$SLF4J_PATH:$LOGBACK_PATH:$COMMONS_PATH:$ZOOKEEPER_PATH:$PEER_SERDES_PATH:$PEER_CLI_PATH:$CONF_PATH
