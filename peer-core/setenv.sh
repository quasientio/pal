...
PEER_CLI_PATH=$MVN_REPO/com/ittera/cometa/peer-cli/1.0-SNAPSHOT/peer-cli-1.0-SNAPSHOT.jar

CLASSPATH=$COMPILED_CLASSES:$ASPECTJ_PATH:$GUAVA_PATH:$GUICE_PATH:$JAVAX_INJECT_PATH:$PROTOBUF_PATH:$KAFKA_PATH:$JEROMQ_PATH:$SLF4J_PATH:$LOG4J_PATH:$COMMONS_PATH:$ZOOKEEPER_PATH:$PEER_CLI_PATH:$CONF_PATH
