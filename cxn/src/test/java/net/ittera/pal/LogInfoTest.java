...
import net.ittera.pal.common.KafkaBrokerEndpoint;
...
public class LogInfoTest {
  ...
  public void logInfo_nameAndOneBroker_bootstrapServersOK() {
    ...
    KafkaBrokerInfo brokerInfo =
        new KafkaBrokerInfo(1, "localhost", 4090, 2001, brokerEndpoints, "328972349");
    ...
    String[] expectedBootstrapServers = {"localdomain.localhost:4091", "127.0.0.1:4092"};
    assertArrayEquals(
  ...
  public void logInfo_nameAndTwoBrokers_bootstrapServersOK() {
    ...
    brokerInfoSet.add(
        new KafkaBrokerInfo(1, "localhost", 4090, 2001, brokerEndpoints1, "328972349"));
    ...
    brokerInfoSet.add(
        new KafkaBrokerInfo(1, "localhost", 4090, 2001, brokerEndpoints2, "328972349"));
    ...
    String[] expectedBootstrapServers = {
      "localdomain.localhost:4091", "127.0.0.1:4092", "somedomain.com:4091", "localhost:4092"
    };
    assertArrayEquals(
        Arrays.stream(expectedBootstrapServers).sorted().toArray(),
        Arrays.stream(logInfo.getBootstrapServers().split(",")).sorted().toArray());
  ...
  @Test
  public void equals_sameNameDifferentBrokers_true() {
