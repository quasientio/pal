...
- Only classes compiled with PAL's AspectJ weaving can be intercepted; JDK standard library classes (e.g., `java.lang.String`, `java.util.HashMap`) cannot be intercepted
