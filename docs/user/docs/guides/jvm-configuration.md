...
| `PAL_PEER_LOGGING_CONFIG` | Path to peer Logback configuration file |
| `PAL_CLI_LOGGING_CONFIG` | Path to CLI Logback configuration file |
...
| `PAL_PEER_LOGGING_CONFIG` | `pal run` | _(unset)_ | Peer Logback config file |
| `PAL_CLI_LOGGING_CONFIG` | CLI commands | _(unset)_ | CLI Logback config file |
