package net.ittera.pal.rpc.json.dsl;

import static net.ittera.pal.dsl.jsonrpc.RpcChain.args;
...
import net.ittera.pal.dsl.jsonrpc.RpcChain;
...
public class RpcChainIT extends AbstractIntegrationTest {
  ...
  private static final String VARS_CLASS_NAME = "net.ittera.pal.apps.rpc.Variables";
  private static final String METHODS_CLASS_NAME = "net.ittera.pal.apps.rpc.Methods";
