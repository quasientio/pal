...
public class VoidClassMethodTest extends AbstractConcentratorTest {
  ...
  public void publicStaticVoidMain() {
    ...
    DataMessage requestMsg = dataMessageBuilder.buildClassMethod(clientId, className, methodName, parameterTypesNamesArray, parameters, new String[parameterTypes.length]);
    DataMessage replyMsg = sendAndReceive(requestMsg);
